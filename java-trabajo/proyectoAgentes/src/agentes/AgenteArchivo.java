...
public class AgenteArchivo extends GuiAgent {
    ...
    protected void onGuiEvent(GuiEvent ge) {
        ...
        try {
            ...
            String per=vfile.obtenerPorcentaje();
            file = new BufferedReader(new FileReader(ruta)); //Se lee el archivo
            String contenido=per+"***"+convertir(file);
            msg.setContent(contenido);//se le añade el contenido al objeto de tipo mensaje, convirtiendo el Buffer en un String
